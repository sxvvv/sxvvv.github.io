...
<span id="typed-about-me"></span>
<div id="about-me-source" style="display: none;">
...
document.addEventListener('DOMContentLoaded', function() {
  // 检查是否已经播放过动画
  if(!sessionStorage.getItem('typedAnimationPlayed')) {
    // 获取文本内容
    var textContent = document.getElementById('about-me-source').innerHTML;
    
    // 初始化 Typed.js
    var typed = new Typed('#typed-about-me', {
      strings: [textContent],
      typeSpeed: 20,        // 打字速度 (毫秒/字符)
      startDelay: 50,      // 开始前的延迟
    ...
    // 如果已经播放过，直接显示全部内容
    document.getElementById('typed-about-me').innerHTML = 
      document.getElementById('about-me-source').innerHTML;
  }
});
</script>
